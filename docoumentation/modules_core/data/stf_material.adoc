...
== Implementations
* Blender: https://github.com/emperorofmars/stf_blender/blob/master/stfblender/modules/core/stf_material/stf_material.py[GitHub] | https://codeberg.org/emperorofmars/stf_blender/src/branch/master/stfblender/modules/core/stf_material/stf_material.py[Codeberg]
