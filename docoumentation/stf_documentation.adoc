...
==== Modification
They are a special kind that can exist only on instantiations of `Data` kinds. For example on xref:./resources/component/stf_instance_prefab.adoc[`stf.instance.prefab`] and xref:./resources/component/stf_instance_armature.adoc[`stf.instance.armature`].
